// File copied as is from GitHub https://github.com/near/near-indexer-for-explorer/blob/master/circulating-supply/src/lockup.rs
...
pub(super) async fn get_lockup_contract_state(
    ...
    let state_response = rpc_client.call(query).await?;
