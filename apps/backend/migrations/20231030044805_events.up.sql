CREATE TYPE event_cause AS ENUM (
  'MINT',
  'TRANSFER',
  'BURN'
);
...
SELECT create_hypertable ('ft_events', 'block_timestamp', chunk_time_interval => 604800000000000);

SELECT create_hypertable ('nft_events', 'block_timestamp', chunk_time_interval => 3628800000000000);



SELECT set_integer_now_func('ft_events', 'epoch_nano_seconds');

SELECT set_integer_now_func('nft_events', 'epoch_nano_seconds');
