...
export const fetchStatsOverview = cache(
  async (account: string): Promise<AccountStatsOverview | null> => {
...
export const fetchTxnsHeatmap = cache(
  async (account: string): Promise<AccountTxnStats[] | null> => {
...
export const fetchBalanceStats = cache(
  async (account: string): Promise<AccountBalanceStats[] | null> => {
...
export const fetchNearStats = cache(
  async (account: string): Promise<AccountNearStats[] | null> => {
...
export const fetchFTStats = cache(
