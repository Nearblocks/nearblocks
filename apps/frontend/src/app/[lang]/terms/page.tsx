      ...
      <div className="bg-card container mx-auto flex flex-1 rounded-lg px-4 py-10">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-10">
            ...
            (&quot;Terms&quot;) apply to your access to and use of all services
            (our &quot;Services&quot;) provided by nearblocks.io
            (&quot;Company,&quot; &quot;we,&quot; or &quot;us&quot;)
          </p>
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <p className="mb-4">
              ...
              binding contract; (b) have not previously been suspended or
            ...
            <p>
              ...
              entity, you further represent and warrant that (i) such legal
              entity is duly organized and validly existing under the applicable
              laws of the jurisdiction of its organization, and (ii) you are
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <p>
              You acknowledge and agree that Company will not be responsible for
              ...
              Company takes no responsibility for and will not be liable for any
              losses, damages or claims arising from the use of our Services,
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <ul className="list-disc space-y-3 pl-6">
              ...
              <li>
                ...
                illegal activities, including, but not limited to illegal
                gambling, fraud, money-laundering, or terrorist activities;
              </li>
              <li>
                Use any robot, spider, crawler, scraper or other automated means
                or interface not provided by us to access our Services or to
                extract data;
              </li>
              <li>
                Engage in Automated Data Collection (scraping) unless such
                Automated Data Collection is confined solely to search indexing
              ...
              <li>
                ...
                employ, or attempt to access any service or area of our Services
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <div className="space-y-4">
              <p>
                ...
                - You are solely responsible for the content of, and for any
                harm resulting from, any User-Generated Content that you post,
                upload, link to or otherwise make available via the Service,
                regardless of the form of that Content. We are not responsible
                for any public display or misuse of your User-Generated Content.
                We have the right (though not the obligation) to refuse or
                remove any User-Generated Content that, in our sole discretion,
                violates any NearBlocks terms or policies.
              </p>
              <p>
                <span className="font-semibold">
                  6.2. Ownership of Content &amp; Right to Post
                </span>{' '}
                - If you&apos;re posting anything you did not create yourself or
                do not own the rights to, you agree that you are responsible for
                any Content you post; that you will only submit Content that you
                have the right to post; and that you will fully comply with any
                third party licenses relating to Content you post.
              </p>
              <p>
                <span className="font-semibold">6.3. License Grant to Us</span>{' '}
                - We need the legal right to do things like host Your Content,
                publish it, and share it. You grant us and our legal successors
                the right to store, parse, and display your content, and make
                incidental copies as necessary to render the Website and provide
                the service.
              </p>
              <p>
                <span className="font-semibold">6.4. Moral Rights</span> - You
                retain all moral rights to Your Content that you upload,
                ...
                reasonably exercise the rights granted in Section 6.3.
              </p>
              <p>
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <p className="mb-4">
              ...
              Services, including, without limitation, the Company or Company
              logo and all designs, text, graphics, pictures, information, data,
              software, sound files, other files and the selection and
              arrangement thereof (collectively, &quot;Company Materials&quot;)
              are the proprietary property of Company or our licensors or
              suppliers and are protected by copyright laws and other
            ...
            <p>
              ...
              provided that full and clear credit is given to nearblocks.io with
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <p className="mb-4">
              ...
              product or service names, logos or slogans that may appear on our
              Services are trademarks of Company and may not be copied, imitated
              or used, in whole or in part, without our prior written
              permission.
            </p>
            <p className="mb-4">
              You will not use any trademark, product or service name of Company
              without our prior written permission, including without limitation
              any metatags or other &quot;hidden text&quot; utilizing any
              trademark, product or service name of Company. In addition, the
              look and feel of our Services, including all page headers, custom
              graphics, button icons and scripts, is the service mark, trademark
              and/or trade dress of Company and may not be copied, imitated or
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <p className="mb-4">
              In the event of any Force Majeure Event, breach of these Terms, or
              any other event that would make provision of the Services
              commercially unreasonable for Company, we may, in our discretion
              and without liability to you, with or without prior notice,
              suspend your access to all or a portion of our Services.
            </p>
            <p>
              We may terminate your access to the Services in our sole
              discretion, immediately and without prior notice, and delete or
              deactivate your Account and all related information and files in
              such account without liability to you, including, for instance, in
              the event that you breach any term of these Terms.
            </p>
          </section>
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <p className="mb-4">
              ...
              the site. Cookies are typically stored on your computer&apos;s
              hard drive.
            </p>
            <p className="mb-4">
              ...
              determine such things as which parts of our Site are most visited
              and difficulties our visitors may experience in accessing our
              Site. With this knowledge, we can improve the quality of your
            ...
            <p className="mb-4">
              ...
              things as how visitors navigate around our site, what pages are
              browsed and general transaction information. Our service
              provider(s) analyses this information and provides us with
              aggregate reports. The information and analysis provided by our
              service provider(s) will be used to assist us in better
              understanding our visitors&apos; interests in our Site and how to
              better serve those interests. The information collected by our
              service provider(s) may be linked to and combined with information
              that we collect about you while you are using the platform. Our
            ...
            <p>
              Your continued use of this site, as well as any subsequent usage,
              will be interpreted as your consent to cookies being stored on
              your device.
            </p>
          </section>
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <div className="space-y-4">
              <p>
                ...
                EXCEPT AS EXPRESSLY PROVIDED TO THE CONTRARY IN A WRITING BY US,
                OUR SERVICES ARE PROVIDED ON AN &quot;AS IS&quot; AND &quot;AS
                AVAILABLE&quot; BASIS TO THE MAXIMUM EXTENT PERMITTED UNDER
                APPLICABLE LAW. WE EXPRESSLY DISCLAIM, AND YOU WAIVE, ALL
                WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING,
                WITHOUT LIMITATION, IMPLIED WARRANTIES OF MERCHANTABILITY,
                FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NON-INFRINGEMENT AS
                TO OUR SERVICES, INCLUDING THE INFORMATION, CONTENT AND
                MATERIALS CONTAINED THEREIN.
              </p>
              <p>
                (b) YOU ACKNOWLEDGE THAT INFORMATION YOU STORE OR TRANSFER
                THROUGH OUR SERVICES MAY BECOME IRRETRIEVABLY LOST OR CORRUPTED
                OR TEMPORARILY UNAVAILABLE DUE TO A VARIETY OF CAUSES, INCLUDING
                ...
                WITHIN OR OUTSIDE OUR CONTROL. YOU ARE SOLELY RESPONSIBLE FOR
                BACKING UP AND MAINTAINING DUPLICATE COPIES OF ANY INFORMATION
                YOU STORE OR TRANSFER THROUGH OUR SERVICES.
              </p>
            </div>
          </section>
          ...
          <section className="text-muted-foreground mb-8">
            ...
            <p>
              EXCEPT AS OTHERWISE REQUIRED BY LAW, IN NO EVENT SHALL COMPANY,
              OUR DIRECTORS, MEMBERS, EMPLOYEES OR AGENTS BE LIABLE FOR ANY
              ...
              OUR SERVICES OR THE COMPANY MATERIALS, INCLUDING WITHOUT
              LIMITATION ANY DAMAGES CAUSED BY OR RESULTING FROM RELIANCE BY ANY
              USER ON ANY INFORMATION OBTAINED FROM COMPANY, OR THAT RESULT FROM
              ...
              UNAUTHORIZED ACCESS TO COMPANY&apos;S RECORDS, PROGRAMS OR
              SERVICES.
            </p>
          </section>
          ...
          <section className="text-muted-foreground">
            ...
            <p className="mb-4">
              You agree to defend, indemnify and hold harmless Company (and each
              of our officers, directors, members, employees, agents and
            ...
            <p className="mb-2">(b) any Feedback you provide;</p>
            <p className="mb-2">(c) your violation of these Terms; or</p>
            <p>
