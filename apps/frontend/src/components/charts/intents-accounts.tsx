...
export const IntentsAccountsChart = ({ loading, statsPromise }: Props) => {
  ...
  return (
    <Card>
      <ChartHeader
        description={t('intentsAccounts.description')}
        logView={logView}
              ...
              isEmpty ? (
                ...
                <AnalyticsChart height={560}>
                  ...
                  <YAxis
                    ...
                    labels={yAxisLabel}
                    opposite={false}
                    title={{ text: t('intentsAccounts.yAxis') }}
                  ...
                  <Area.Series
                    ...
                    options={{
                      ...
                      id: 'daily',
                      name: t('intentsAccounts.seriesDaily'),
                      yAxis: 0,
                    }}
                  />
...
export const IntentsAccountsChartMini = ({ loading, statsPromise }: Props) => {
  const { t } = useLocale('charts');
  const stats = !loading && statsPromise ? use(statsPromise) : null;
