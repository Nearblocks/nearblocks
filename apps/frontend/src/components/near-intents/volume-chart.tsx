    ...
    <Card>
      <CardHeader className="border-b">
        <p className="text-body-sm text-muted-foreground">
          {t('nearIntents.dashboard.charts.volume.title')}
        </p>
      </CardHeader>
              ...
              isEmpty ? (
                ...
                <AnalyticsChart height={560}>
                  ...
                  <YAxis
                    ...
                    opposite={false}
                    title={{
                      text: t('nearIntents.dashboard.charts.volume.yAxis'),
                    }}
                  />
                  <Column.Series
                    data={daily}
                    options={{
                      id: 'daily',
                      name: t(
                        'nearIntents.dashboard.charts.volume.seriesDaily',
                      ),
                      yAxis: 0,
                    }}
                  />
                  <YAxis
                    ...
                    title={{
                      text: t(
                        'nearIntents.dashboard.charts.volume.yAxisCumulative',
                      ),
                    }}
                  />
                  <Line.Series
                    ...
                    options={{
                      id: 'cumulative',
                      name: t(
                        'nearIntents.dashboard.charts.volume.seriesCumulative',
                      ),
                      yAxis: 1,
                    }}
                  />
