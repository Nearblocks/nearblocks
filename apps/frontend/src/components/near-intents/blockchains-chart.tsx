...
export const IntentsBlockchainsChart = ({ loading, statsPromise }: Props) => {
    ...
    <Card>
      <CardHeader className="border-b">
        <p className="text-body-sm text-muted-foreground">
          {t('nearIntents.dashboard.charts.uniqueBlockchains.title')}
        </p>
      </CardHeader>
              ...
              isEmpty ? (
                ...
                <AnalyticsChart height={560}>
                  ...
                  <YAxis
                    ...
                    title={{
                      text: t(
                        'nearIntents.dashboard.charts.uniqueBlockchains.yAxis',
                      ),
                    }}
                  />
                  <Area.Series
                    ...
                    options={{
                      ...
                      id: 'daily',
                      name: t(
                        'nearIntents.dashboard.charts.uniqueBlockchains.seriesDaily',
                      ),
                      yAxis: 0,
                    }}
                  />
