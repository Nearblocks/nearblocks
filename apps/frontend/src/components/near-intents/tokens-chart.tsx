...
export const IntentsTokensChart = ({ loading, statsPromise }: Props) => {
    ...
    <Card>
      <CardHeader className="border-b">
        <p className="text-body-sm text-muted-foreground">
          {t('nearIntents.dashboard.charts.uniqueTokens.title')}
        </p>
      </CardHeader>
              ...
              isEmpty ? (
                ...
                <AnalyticsChart height={560}>
                  ...
                  <YAxis
                    ...
                    title={{
                      text: t(
                        'nearIntents.dashboard.charts.uniqueTokens.yAxis',
                      ),
                    }}
                  />
                  <Area.Series
                    ...
                    options={{
                      ...
                      id: 'daily',
                      name: t(
                        'nearIntents.dashboard.charts.uniqueTokens.seriesDaily',
                      ),
                      yAxis: 0,
                    }}
                  />
