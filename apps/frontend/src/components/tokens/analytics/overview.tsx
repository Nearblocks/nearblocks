...
type Props = {
  heatmapPromise?: Promise<FTContractStatsHeatmapRes>;
  loading?: boolean;
  overviewPromise?: Promise<FTContractStatsOverviewRes>;
};
...
export const OverviewChart = ({
  ...
  const overview: FTContractStatsOverview | null = overviewRes?.data ?? null;
  const heatmapData: FTContractStatsHeatmap[] = heatmapRes?.data ?? [];
