      ...
      <div className="mb-10 grid grid-cols-1 gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="px-3">
            <List pairsPerRow={1}>
              <ListItem>
                <ListLeft className="min-w-20">Status</ListLeft>
                <ListRight>
                  {isTopLoading ? (
        ...
        <Card>
          ...
          <CardContent className="px-3">
            <List pairsPerRow={1}>
              <ListItem>
                <ListLeft className="min-w-20">Blocks</ListLeft>
                <ListRight>
                  {validatorsLoading ? (
                    ...
                    <span className="flex flex-wrap items-center gap-2">
                      ...
                      <span className="text-muted-foreground">
                        {numberFormat(blocksProduced)} produced /{' '}
                        {numberFormat(blocksExpected)} expected
                      </span>
                    </span>
                  )}
                </ListRight>
                ...
                <ListRight>
                  {validatorsLoading ? (
                    ...
                    <span className="flex flex-wrap items-center gap-2">
                      ...
                      <span className="text-muted-foreground">
                        {numberFormat(chunksProduced)} produced /{' '}
                        {numberFormat(chunksExpected)} expected
                      </span>
                    </span>
                  )}
                </ListRight>
        ...
        <DataTable
          ...
          header={
            totalLoading ? (
              ...
              `${numberFormat(total)} Delegators found`
            ) : undefined
          }
