...
import service from '#services/v3/staking/index';

const route = Router();

const routes = (app: Router) => {
  app.use('/staking-txns', bearerAuth, rateLimiter, route);
  ...
  /**
   * @openapi
   * /v3/staking-txns/count:
   *   get:
   *     summary: Get estimated staking transaction count
   *     x-internal: true
   *     tags:
   *       - Staking
   *     parameters:
