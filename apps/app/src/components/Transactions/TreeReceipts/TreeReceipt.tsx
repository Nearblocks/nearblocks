  ...
  return (
    <>
      {receipt?.actions && (
        ...
        >
          {!isSuccess && (
            <p className="absolute text-red-500 bg-red-50 dark:bg-black top-0 right-0 text-[8px] inline-flex items-center rounded-md -mt-2 -mr-4 px-1">
              <FaTimesCircle /> <a className="ml-1">Failure</a>
            </p>
          )}
