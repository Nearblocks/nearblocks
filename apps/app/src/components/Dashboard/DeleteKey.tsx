      ...
      >
        ...
        <div className="px-6 pb-5 pt-2">
          ...
          <div className="flex items-center justify-end  py-4">
            <p
              onClick={onToggleDelete}
              className="text-[13px] delay-300 duration-300 mx-1 hover:bg-gray-200 px-3 py-2 rounded cursor-pointer"
            >
              Cancel
            </p>
            <button
              onClick={onDelete}
              className="text-[13px] text-white font-semibold px-3 py-2 bg-green-500 dark:bg-green-250 hover:-translate-y-1 hover:scale-100 duration-300 hover:shadow-md hover:shadow-primary rounded-md"
            >
              Remove
            </button>
          </div>
