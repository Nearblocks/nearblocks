    ...
    >
      ...
      >
        ...
        <div className="px-6 pb-5 pt-2">
          {selected && (
            <div className="py-2">
              <p className="text-sm text-gray-500 dark:text-neargray-10 py-2">
                Key
              </p>
              <input
                name="key"
                ...
                value={key?.token}
                disabled
                className="w-full border dark:border-black-200 rounded text-xs outline-primary py-2 px-2"
              />
            </div>
          )}
          <div className="py-2">
            ...
            <input
              ...
              className="w-full border dark:border-black-200 dark:bg-black-300 rounded text-xs outline-primary py-2 px-2"
            />
          ...
          <div className="flex items-center justify-end  py-4">
            ...
            <button
              ...
              className={`text-sm text-[13px] px-3 focus:outline-none  text-white text-center font-semibold py-3 bg-green-500 dark:bg-green-250 hover:-translate-y-1 hover:scale-100 duration-300 hover:shadow-md hover:shadow-primary rounded ${
                formik.isSubmitting &&
