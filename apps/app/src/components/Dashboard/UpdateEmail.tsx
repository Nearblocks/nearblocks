    ...
    <div className="w-full bg-white dark:bg-black-600 dark:text-neargray-10 rounded-xl  soft-shadow h-fit mb-4">
      ...
      <div className="gap-1 items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1 items-center px-6 py-4  border-b dark:border-black-200">
          <p className="text-gray-500 dark:text-neargray-10 text-sm flex items-center mb-2">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-start">
              <input
                ...
                className="border px-3 py-2 text-sm outline-primary rounded-md dark:bg-black-300 dark:border-black-200"
              />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-1 items-center px-6 py-4  border-b dark:border-black-200">
        ...
        <div className="flex flex-col items-start col-span-2">
          <input
            ...
            onChange={formik.handleChange}
            // className="border px-3 py-2 text-sm outline-primary rounded-md "\
            className="w-full border px-3 py-2 text-sm outline-primary rounded-md dark:bg-black-300 dark:border-black-200"
          />
      ...
      <div className="flex items-center justify-end px-6 py-4">
        <button
          className="text-[13px] delay-300 duration-300 mx-1 hover:bg-gray-200 dark:hover:bg-black-200 px-6 py-2 rounded"
        ...
        <button
          ...
          className={`text-sm text-[13px] px-6 focus:outline-none text-white dark:text-neargray-10  text-center font-semibold  py-2 bg-green-500 dark:bg-green-250 rounded hover:-translate-y-1 hover:scale-100 duration-300 hover:shadow-md hover:shadow-primary ${
