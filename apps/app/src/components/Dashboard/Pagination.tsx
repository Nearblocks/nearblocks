...
const Pagination = ({
  ...
  return (
    <>
      <div
        className={`bg-white dark:bg-black-600 flex items-center lg:justify-between justify-end ${
          ...
          >
            <button
              ...
              className={`relative inline-flex items-center px-2 ml-1 md:px-3 text-xs py-2 font-medium ${
                disabled
                  ? 'text-gray-500 dark:text-neargray-50'
                  : 'text-primary dark:text-neargray-10 hover:text-white hover:bg-primary'
            ...
            <button
              ...
              className={`relative inline-flex items-center ml-1 px-2 md:px-3 py-2 rounded-md font-medium ${
                nextPageParams
                  ? 'text-primary hover:text-white dark:text-neargray-10 hover:bg-primary'
                  : 'text-gray-500 dark:text-neargray-50'
