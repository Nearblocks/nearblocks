...
export function OverviewCardSkeleton({ error = false }: { error?: boolean }) {
...
export default function BalanceSkeleton({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <OverviewCardSkeleton error={error} />
      <MoreInfoCardSkeleton
        error={error}
        deploymentPromise={deploymentPromise}
        ftPromise={ftPromise}
        nftPromise={nftPromise}
      />
