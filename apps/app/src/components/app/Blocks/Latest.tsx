  ...
  return (
    <>
      ...
      {blocks && blocks?.length > 0 && (
        <div className="border-t dark:border-black-200 px-2 py-3 text-nearblue-600">
          <Link href="/blocks">
            <span className="block  dark:text-white text-center border border-green-900/10 bg-green-500 dark:bg-black-600/[0.75] hover:bg-green-400 font-semibold dark:font-semibold dark:hover:text-green-250 text-white dark:text-sm text-sm py-3 rounded w-full focus:outline-none hover:no-underline cursor-pointer">
              View all blocks
            </span>
          </Link>
        </div>
