...
const TransactionActions = ({
  ...
  if (!actionparsed?.Actions?.length) {
    return null;
  }
        ...
        <div className="px-4 py-2.5">
          <div className="flex gap-4 mb-2">
            ...
            <div className="flex flex-col flex-1">
              Transaction Actions
              {loading ||
              (actionparsed.Actions?.length === 0 && actionparsed.Actions) ? (
                ...
                <div>
                  <div
                    ref={actionRef}
                    className={`max-h-[194px] overflow-y-auto transition-all duration-300  mt-1 ${
                      isActionScrollable
