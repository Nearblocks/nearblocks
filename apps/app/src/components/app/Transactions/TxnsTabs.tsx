...
export default async function TxnsTabs({
  ...
  console.log({ actions: txnData.actions });
  console.log({ subActions: txnData.subActions });
  console.log({ tokenMetadata: txnData.tokenMetadata });
