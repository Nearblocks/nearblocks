...
const UseGlobalContractByAccountId = (props: TransactionActionInfo) => {
  ...
  const displayData = displayArgs(args);

  return (
    <>
      <div className="pt-1">
        <FaCode className="inline-flex text-emerald-400 mr-1" />{' '}
        {'Use Global Contract By AccountId'} (
        <Link
...
export default UseGlobalContractByAccountId;
