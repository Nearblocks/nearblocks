...
const TokenHoldings = (props: Props) => {
  ...
  return (
    <PopoverRoot positioning={{ sameWidth: true }}>
      <PopoverTrigger
        asChild
        className="sm:!w-72 w-64 relative h-8 text-sm px-2 rounded border dark:border-black-200 outline-none flex items-center justify-between cursor-pointer"
      >
        <button>
          <span>
      ...
      <PopoverContent
        className="bg-white sm:!w-72 w-64 -mt-2 rounded-b-lg shadow border z-10 pb-2 dark:border-black-200 dark:bg-black overflow-hidden focus:outline-none"
        roundedBottom={'lg'}
        roundedTop={'none'}
      >
