...
const MenuItem: FC<MenuItemProps> = ({
  ...
  <div className="hover:text-primary text-gray-600 dark:text-neargray-100 rounded-md cursor-pointer">
    <ActiveLink
      href={href}
      inActiveClassName="py-2 hover:bg-primary-100 dark:hover:bg-black-200 dark:hover:text-green-100 rounded-md my-1"
      activeClassName="text-primary dark:text-green-100 py-2 bg-primary-100 dark:bg-black-200 rounded-md my-1"
      exact={exact}
    >
      <span className="flex">
        <Icon className="h-4 w-4 mx-2 hover:text-primary" />
          ...
          <div className="lg:flex block pb-20">
            <div className="xl:w-[28%] lg:w-[35%] w-[100%] bg-white dark:bg-black-600 rounded-xl soft-shadow border h-fit mb-4 mr-8">
              ...
              >
                <div>
                  {loading ? (
                    <Loader wrapperClassName="flex w-28 h-5" />
                  ) : (
                  ...
                  {loading ? (
                    <Loader wrapperClassName="flex w-40 h-4 mt-4" />
                  ) : (
                ...
                {role == 'advertiser' && (
                  <div className="px-4 py-2">
                    ...
                    <MenuItem
                      ...
                      text="Invoices"
                    />
                    <div className="flex py-2 hover:bg-primary-100 dark:hover:bg-black-200 hover:text-primary dark:hover:text-green-100  text-gray-600 dark:text-neargray-100 rounded-md cursor-pointer">
