...
const CampaignListing = () => {
  ...
  return (
    <>
      <div className="bg-white dark:bg-black-600 dark:text-neargray-10 border dark:border-black-200 soft-shadow rounded-lg">
          ...
          <table className="min-w-full divide-y dark:divide-black-200 border-t dark:border-black-200 text-black dark:text-neargray-10">
            ...
            <tbody className="bg-white dark:bg-black-600 divide-y divide-gray-200">
              ...
              {data?.data?.map((item: currentCampaign) => (
                <tr className="h-[57px] hover:bg-blue-900/5" key={item?.key}>
                  <td className="px-5 py-4 whitespace-nowrap text-sm ">
