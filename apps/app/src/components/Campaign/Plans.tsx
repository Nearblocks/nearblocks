              ...
              >
                ...
                <div className="px-4 py-4">
                  ...
                  <button
                    ...
                    className={`text-sm hover:bg-primary text-white font-semibold px-7 ${
                      ...
                      purchasedPlanId == plan?.id
                        ? 'mt-3'
                        : 'my-6'
                    }  bg-green-500 dark:bg-green-250 dark:text-neargray-10 rounded w-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 hover:shadow-md hover:shadow-primary`}
                  >
