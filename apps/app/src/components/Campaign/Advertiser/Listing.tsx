...
const Listing = ({ statsMutate }: Props) => {
  ...
  return (
    <>
      <div className="block lg:flex lg:space-x-2 rounded-xl">
        <div className="w-full rounded-xl">
          <div className="bg-white dark:bg-black-600 dark:text-neargray-10 border dark:border-black-200 soft-shadow rounded-xl">
            <div className={`flex flex-col lg:flex-row pt-4 justify-between`}>
              <div className="flex flex-col">
                <h1 className="leading-7 px-6 text-base text-black dark:text-neargray-10">
                  My Campaigns
                </h1>
                <div className="leading-7 px-6 text-sm mb-4 text-gray-500 dark:text-neargray-10">
                  <p>
            ...
            <div className="overflow-x-auto ">
              <table className="min-w-full divide-y dark:divide-black-200 border-t dark:border-black-200 text-black">
                ...
                <tbody className="divide-y dark:bg-black-600 divide-gray-200">
                  {loading &&
                    [...Array(4)].map((_, i) => (
                  ...
                  {data?.data?.map((item: currentCampaign) => (
                    <tr
                      className="h-[57px] dark:text-neargray-10 dark:bg-black-200 hover:bg-blue-900/5"
                      key={item?.id}
                    >
                      <td className="px-5 py-4 whitespace-nowrap text-sm">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap flex gap-x-2 items-center text-xs text-gray-500 dark:text-neargray-10 align-top">
                        <div className="flex items-center border border-green-500 dark:border-green-250 rounded-md px-2 py-1 hover:bg-primary-100 dark:hover:bg-black-200">
                          <Link
                            passHref
                          ...
                          >
                            <Edit className=" text-green-500 dark:text-neargray-10 " />{' '}
                            &nbsp;
                        ...
                        {item?.subscription?.status === 'canceled' ? (
                          <span className="bg-red-100 text-xs text-red-500 rounded-xl px-2 py-1 max-w-[120px] inline-flex truncate">
                            Cancelled
                          </span>
                        ) : (
                          <div
