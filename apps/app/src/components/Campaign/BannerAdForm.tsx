...
import { bannerCampaignValidation } from '@/utils/validationSchema';
      ...
      <form>
        <div className="rounded-xl border dark:border-black-200 soft-shadow">
          <div className="px-5 py-5 border-b dark:border-black-200">
            <p className="text-base text-black">Campaign Information</p>
          </div>
          <p className="text-sm text-gray-400 mt-2 px-6 py-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-1 items-center px-6 py-4 border-b dark:border-black-200">
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-start col-span-2">
                  <div className="h-[70px] border dark:border-black-200 w-full relative text-black dark:bg-black-300 px-3 py-2 text-sm outline-primary rounded-md">
            ...
            <div className="ml-[51px] py-4 mr-6 flex flex-col items-end">
              <button
                ...
                className={`text-sm text-[13px] px-10 focus:outline-none text-white text-center font-semibold py-2 rounded ${
