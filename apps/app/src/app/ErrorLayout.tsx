...
import GlobalErrorFooter from '@/components/app/common/GlobalErrorFooter';
import GlobalErrorHeader from '@/components/app/common/GlobalErrorHeader';
...
export default function ErrorLayout({ reset }: { reset: () => void }) {
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      try {
        const [messages, stats, syncStatus, signedAccountId] =
          await Promise.all([
            getMessage(),
            getLatestStats(),
            getSyncStatus(),
