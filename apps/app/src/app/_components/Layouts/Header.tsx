...
const Header = () => {
  ...
  const handleClickLang = (locale: string) => {
    // Remove the first segment of the pathname (current locale)
                      ...
                      <ul className="border-l-2 border-green-500 dark:border-green-250 md:!hidden ml-4">
                        {languages.map((language) => (
                          <li key={language.locale}>
                            ...
                            <a
                              onClick={() => handleClickLang(language?.locale)}
                              className="block w-full hover:text-green-500 dark:hover:text-green-250 py-2 px-4 cursor-pointer"
                            >
                              {language.title}
                            </a>
                            {/* </ActiveLink> */}
                      ...
                      <ul className="bg-white  dark:bg-black-600 soft-shadow hidden  absolute top-full rounded-b-lg !border-t-2 !border-t-green-500 group-hover:block py-2 z-[99]">
                        {languages.map((language) => (
                          <li key={language.locale}>
                            ...
                            <a
                              onClick={() => handleClickLang(language?.locale)}
                              className="block w-full hover:text-green-500 dark:hover:text-green-250 whitespace-nowrap py-2 px-4 cursor-pointer"
                            >
                              {language.title}
                            </a>
                            {/* </ActiveLink> */}
