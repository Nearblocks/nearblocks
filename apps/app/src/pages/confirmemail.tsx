        ...
        <div className="container mx-auto">
          <div className="mx-auto px-5 align-middle max-w-[685px]">
            {[200, 204].includes(status) && (
              <div className="py-36">
                <h1 className="text-3xl text-primary py-4 text-center">
                  Confirm Your Email
                </h1>
                <div className="bg-blue-200/30 text-primary rounded-md px-5 py-5">
            ...
            {[422, 400].includes(status) && (
              <div className="py-28">
                <h1 className="text-3xl text-primary dark:text-green-250 py-4 text-center">
                  Verification Failed
                </h1>
