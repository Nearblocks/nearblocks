...
const PrivacyPolicy = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>{'Privacy Policy | Nearblocks'}</title>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-10 col-xl-9">
            <div className="flex flex-col">
              <div className="md:px-14 flex flex-col mx-2">
                <div className="relative overflow-hidden">
                  <div className="bg-green-500 dark:bg-black-600 p-6 pb-8 px-md-8 pt-md-10 pb-md-14 rounded-xl">
                    <div className="flex flex-col md:flex-row justify-between gap-6 p-8 mb-2">
                      <div className="md:order-2">
                        <Link href="/" legacyBehavior>
                          <a className="flex justify-start items-center hover:no-underline bg-white  py-2 px-6 rounded-lg  dark:bg-black-600 dark:text-neargray-10">
                            <Image
                              src={
                                theme === 'dark'
              ...
              <div className="md:px-14 flex flex-col items-start mx-2">
                <div className="text-base text-neargray-600 dark:text-neargray-10 pt-12 pb-16 px-6 w-full bg-white dark:bg-black-600 flex flex-col gap-6">
                  ...
                  <p>
                    ...
                    Personal Data and takes the matter of protecting your
                    privacy as high priority.
                  </p>
                  ...
                  <p>
                    (b) contact information, e.g., address, phone number and
                    email address;
                  </p>
                  <p>
                    (<span className="p-[0.1px]">c</span>) technical
                    information, e.g., IP address for API services and login;
                  </p>
                  ...
                  <p>
                    ...
                    interact with Nearblocks, unless a different privacy policy
                    is displayed. This policy also explains your choices about
                  ...
                  <p>
                    ...
                    our Services. Each time you use any Site, or any Services,
                  ...
                  <p>
                    (<span className="p-[0.1px]">c</span>) when you contact us
                    in person;
                  </p>
                  <p>(d) when we contact you in person;</p>
                  <p>
                    (e) when we collect information about you from third
                    parties; and other channels including our support helpdesk.
                  </p>
                  ...
                  <p>(b) Cookies</p>
                  <p>
                    A cookie is an element of data that a website can send to
                    your browser, which may then store it on your system. We use
                    cookies in some of our pages to store your preferences and
                    record session information. The information that we collect
                    is then used to ensure a more personalized service level for
                    our users. You can adjust settings on your browser so that
                    you will be notified when you receive a cookie. Please refer
                    to your browser documentation to check if cookies have been
                    enabled on your computer or to request not to receive
                    cookies.
                  </p>
                  <p>
                    ...
                    cookies, you will not be able to use any products or
                    services on the website that may require you to log-in
                    (token holdings store cookies for favorite).
                  </p>
                  <p>
                    It is important that you prevent unauthorized access to your
                    password and your computer. You should always log out after
                    using a shared computer. Information collected from cookies
                    is used by us to evaluate the effectiveness of our site,
                    analyze trends, and manage the platform. The information
                    collected from cookies allows us to determine such things as
                    which parts of our site are most visited and difficulties
                    our visitors may experience in accessing our site.
                  </p>
                  <p>
                    With this knowledge, we can improve the quality of your
                    experience on the platform by recognizing and delivering
                    more of the most desired features and information, as well
                    as by resolving access difficulties. We also use cookies
                    and/or a technology known as web bugs or clear gifs, which
                    are typically stored in emails to help us confirm your
                  ...
                  <p>
                    Our feedback form requires you to give us contact
                    information (e.g. your name and email address) so that we
                    can respond to your comments. We use your contact
                    information from the registration form to send you
                    information about our company. Your contact information is
                    also used to contact you where necessary.
                  </p>
                  ...
                  <p>
                    ...
                    example, how visitors navigate around our site, what pages
                    are browsed and general transaction information. Our service
                    provider(s) analyzes this information and provides us with
                    aggregate reports.
                  </p>
                  <p>
                    The information and analysis provided by our service
                    provider(s) will be used to assist us in better
                    understanding our visitors&apos; interests in our site and
                    how to better serve those interests. The information
                    collected by our service provider(s) may be linked to and
                    combined with information that we collect about you while
                    you are using the platform. Our service provider(s) is/are
                    contractually restricted from using information they receive
                    from our Site other than to assist us.
                  </p>
                  ...
                  <p>
                    (i) To throttle the rate of requests and prevent certain
                    types of attacks against us, we track the incoming IP
                    addresses for very short periods of time and is then
                    released.
                  </p>
                  <p>
                  ...
                  <p>
                    (d) for business development purposes such as statistical
                    and marketing analysis, systems testing, maintenance and
                  ...
                  <p>
                    (e) to comply with any legal or regulatory requirements;
                    and/ or
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    stated above. (&quot;Ancillary Purposes&quot;)
                  ...
                  <p>
                    ...
                    below: for online registered customers, you may login to
                    your online account and update your personal data.
                  </p>
                  ...
                  <p>
                    ...
                    the right to validate all requests for the authenticity of
                    the request.
                  </p>
                  ...
                  <p>
                    ...
                    without which some services or features provided by
                    Nearblocks may be affected
                  </p>
                  ...
                  <p>
                    We will not trade or sell your Personal Data to third
                    parties. Your Personal Data shall only be disclosed or
                    transferred to the following third parties appointed or
                    authorised by the Company for the fulfilment of the Purpose
                    of: (a) data warehouses; (b) IT service providers; (
                    <span className="p-[0.1px]">c</span>) data analytics and/or
                    marketing agency; (d) legal bodies as permitted or required
                    by law such as in compliance with a warrant or subpoena
                    issued by a court of competent jurisdiction; and/or (e)
                    regulatory authorities applicable to you; and/or (f) safety
                  ...
                  <p>
                    ...
                    affiliates and subsidiaries) or our business, assets or
                    group companies, or in connection with any corporate
                    restructuring or exercise including the our restructuring to
                    transfer the business, assets and/or liabilities.
                  </p>
                  <p>
                    We shall take practical steps to ensure that their
                    employees, officers, agents, consultants, contractors and
                    such other third parties mentioned above who are involved in
                    the collection, use and disclosure of your Personal Data
                    will observe and adhere to the terms of this Privacy
                    Statement.
                  </p>
                  <p>
                    We are subject to various legal and regulatory obligations
                    imposed by the laws and supervisory authorities of various
                    jurisdictions e.g., anti-money laundering laws,
                    anti-terrorism financing, financial services laws,
                    corporation laws and privacy laws. These obligations may
                    require us to process certain data for payment processing,
                    compliance with court orders or other purposes not disclosed
                    herein.
                  </p>
                  ...
                  <p>
                    ...
                    servers across regions and we shall take all reasonable
                    steps to ensure that all Personal Data is destroyed or
                    permanently deleted when no longer required for the Purpose
                    and prepare a disposal schedule for inactive data after 24
                    month period.
                  </p>
                  ...
                  <p>
                    ...
                    personal information. We try, as far as we can, to ensure
                    that all third party linked sites have equivalent measures
                    for protection of your personal information, but we cannot
                    be held responsible legally or otherwise for the activities,
                    privacy policies or levels of privacy compliance of these
                    Third Party Sites.
                  </p>
                  ...
                  <p>
                    ...
                    time to time in accordance to applicable laws and
                    regulations and such variations may be applicable to you.
                  </p>
