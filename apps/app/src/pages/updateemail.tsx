        ...
        <div className="container mx-auto py-20">
          <div className="mx-auto px-5 align-middle max-w-[685px]">
            {[200, 204].includes(status) && (
              <div>
                <h1 className="text-3xl text-primary py-4">
                  Changed Your Email
                </h1>
                ...
                {/* {!isConnected && (
                  <div className="w-full text-right my-4">
                    <button
                      onClick={onLogin}
                      type="button"
                      className="text-sm text-white  text-center font-semibold w-56 py-3 bg-primary rounded"
                    >
                      Back to Login
                    </button>
                  </div>
            ...
            {[422, 400].includes(status) && (
              <div>
                ...
                <div className="bg-red-200/30 text-sm text-red-500 rounded-md px-5 py-5">
