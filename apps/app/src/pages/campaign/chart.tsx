          ...
          <>
            <div>
              <div className="flex-wrap md:flex-nowrap flex">
                <div className="w-full bg-white dark:bg-black-600 mr-4 border soft-shadow rounded-xl px-8">
                ...
                <div className="w-full bg-white dark:bg-black-200 mr-4 mt-2 md:mt-0 border soft-shadow rounded-xl px-8">
                  <h1 className="text-xl mt-8 text-black">
                    <Skeleton className="h-4" />
                  </h1>
                  <p className="mt-4 mb-8 text-3xl text-gray-500">
                ...
                <div className="w-full bg-white  dark:bg-black-200 bordermt-2 md:mt-0 soft-shadow rounded-xl px-8">
                  <h1 className="text-xl mt-8 text-black">
                    <Skeleton className="h-4" />
                  </h1>
                  <p className="mt-4 mb-8 text-3xl text-gray-500">
