...
const TxnVolumeChart = ({
  ...
  return (
    <>
      <Head>
        <title>{t('txnVolume.metaTitle')}</title>
        <meta name="title" content={t('txnVolume.metaTitle')} />
        <meta name="description" content={t('txnVolume.metaDescription')} />
        <meta property="og:title" content={t('txnVolume.metaTitle')} />
        <meta
          property="og:description"
          content={t('txnVolume.metaDescription')}
        />
        <meta property="twitter:title" content={t('txnVolume.metaTitle')} />
        <meta
