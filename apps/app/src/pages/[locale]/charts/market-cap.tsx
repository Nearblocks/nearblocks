...
const MarketCapChart = ({
  ...
  return (
    <>
      <Head>
        <title>{t('marketCap.metaTitle')}</title>
        <meta name="title" content={t('marketCap.metaTitle')} />
        <meta name="description" content={t('marketCap.metaDescription')} />
        <meta property="og:title" content={t('marketCap.metaTitle')} />
        <meta
          property="og:description"
          content={t('marketCap.metaDescription')}
        />
        <meta property="twitter:title" content={t('marketCap.metaTitle')} />
        <meta
