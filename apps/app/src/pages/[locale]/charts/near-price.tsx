...
const NearPriceChart = ({
  ...
  return (
    <>
      <Head>
        <title>{t('nearPrice.metaTitle')}</title>
        <meta name="title" content={t('nearPrice.metaTitle')} />
        <meta name="description" content={t('nearPrice.metaDescription')} />
        <meta property="og:title" content={t('nearPrice.metaTitle')} />
        <meta
          property="og:description"
          content={t('nearPrice.metaDescription')}
        />
        <meta property="twitter:title" content={t('nearPrice.metaTitle')} />
        <meta
