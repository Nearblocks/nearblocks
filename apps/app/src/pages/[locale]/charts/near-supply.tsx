...
const NearSupplyChart = ({
  ...
  const thumbnail = `${ogUrl}/thumbnail/basic?title=${encodeURI(
    t('nearSupply.heading'),
  )}&brand=near`;

  return (
    <>
      <Head>
        <title>{t('nearSupply.metaTitle')}</title>
        <meta name="title" content={t('nearSupply.metaTitle')} />
        <meta name="description" content={t('nearSupply.metaDescription')} />
        <meta property="og:title" content={t('nearSupply.metaTitle')} />
        <meta
          property="og:description"
          content={t('nearSupply.metaDescription')}
        />
        <meta property="twitter:title" content={t('nearSupply.metaTitle')} />
        <meta
