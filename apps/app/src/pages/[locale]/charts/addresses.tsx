  ...
  return (
    <>
      <Head>
        ...
        <meta name="title" content={t('addresses.metaTitle')} />
        <meta name="description" content={t('addresses.metaDescription')} />
        <meta property="og:title" content={t('addresses.metaTitle')} />
        <meta
          property="og:description"
          content={t('addresses.metaDescription')}
        />
        <meta property="twitter:title" content={t('addresses.metaTitle')} />
        <meta
