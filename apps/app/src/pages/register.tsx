          ...
          <div className="mx-auto px-5 align-middle max-w-[685px]">
            {!verify ? (
              <form method="post" onSubmit={formik.handleSubmit}>
                <h1 className="text-3xl text-primary dark:text-green-250 py-2 font-semibold">
                  Register a new account
                </h1>
                <p className="text-sm text-gray-500 dark:text-neargray-100 py-2 font-thin">
                ...
                <div className="py-2">
                  <p className="text-sm text-gray-500 dark:text-neargray-100">
                    <span>
                      <input
                        type="checkbox"
                ...
                <div className="w-full text-left my-2">
                  <button
                    ...
                    className={`text-sm font-semibold focus:outline-none text-white text-center w-56 py-3 hover:bg-green-400 bg-green-500 rounded ${
                      formik.isSubmitting &&
                ...
                <div className="py-2">
                  <p className="text-gray-500 dark:text-neargray-100 text-sm my-1">
              ...
              <div>
                <h1 className="text-3xl text-primary dark:text-green-250 py-4 font-semibold">
                  Register a new account
                </h1>
                <div className="bg-primary-100 dark:bg-blue-900/[0.05] text-sm text-primary dark:text-green-250 rounded-md px-4 py-3">
                ...
                <p className="text-sm dark:text-gray-300 my-6">
                  ...
                  <a
                    onClick={onResend}
                    className="text-primary dark:text-green-250 font-medium cursor-pointer"
                  >
                    resend
                  </a>
                  .
