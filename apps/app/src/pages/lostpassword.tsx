        ...
        <div className="container mx-auto py-20">
          <div className="mx-auto px-5 align-middle max-w-[685px]">
            <form method="post" onSubmit={formik.handleSubmit}>
              ...
              {success && (
                <div className="bg-primary-100 px-4 py-4 rounded-md mt-4">
                  <h2 className="text-primary text-lg my-1 font-medium">
              ...
              <div className="py-2">
                <p className="py-2 text-sm text-gray-500">Email Address</p>
                <input
                  name="email"
                  autoComplete="off"
              ...
              <div className="w-full text-right my-4 justify-between flex items-center">
                ...
                <div>
                  {success && (
                    <button
                      className="text-[13px] delay-300 duration-300 mx-1 hover:bg-gray-200 dark:hover:bg-black-200 font-semibold p-3 rounded"
                      onClick={onResend}
                    >
                      Resend
                    </button>
                  ...
                  {!success && (
                    <button
                      ...
                      className={`text-sm  focus:outline-none text-white  text-center font-semibold p-3 bg-primary rounded ${
                        formik.isSubmitting &&
