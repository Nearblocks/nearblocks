          ...
          <div className="mx-auto px-5 align-middle max-w-[685px]">
            <form method="post" onSubmit={formik.handleSubmit}>
              ...
              <div className="w-full text-right my-4 justify-between flex items-center">
                <a
                  onClick={onLogin}
                  className="underline text-xs text-gray-400 dark:text-neargray-200 cursor-pointer"
                >
                  Back to sign in
                </a>
                <button
                  ...
                  className={`text-sm  focus:outline-none text-white  text-center font-semibold w-56 py-3 hover:bg-green-400 bg-green-500 rounded ${
                    formik.isSubmitting &&
