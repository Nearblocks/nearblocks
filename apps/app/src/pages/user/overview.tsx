    ...
    <Layout latestBlocks={latestBlocks} statsDetails={statsDetails}>
      ...
      <UserLayout title="Account Overview">
        <div className="w-full bg-white dark:bg-black-600 rounded-xl soft-shadow h-fit">
          ...
          <div>
            <p className="text-sm text-gray-400 dark:text-neargray-100 mt-2 px-6 py-4">
            ...
            <div className="grid grid-cols-3 gap-1 items-center px-6 py-4  border-b dark:border-black-200">
              <p className="text-gray-500 dark:text-neargray-100 text-sm flex items-center">
              ...
              <>
                ...
                <div className=" flex justify-end">
                  <Link legacyBehavior href={`/user/settings`}>
                    <div className="w-1/3 flex justify-center	items-center text-center border-2 text-md pl-4 pr-6 py-1 rounded focus:outline-none hover:text-primary dark:hover:text-green-100 font-semibold hover:border-primary-100 hover:bg-primary-100 bg-green-500 dark:bg-reen-250 text-white border-primary cursor-pointer">
