    ...
    <Layout latestBlocks={latestBlocks} statsDetails={statsDetails}>
      ...
      <UserLayout title="Current Plan">
        <div className="w-full bg-white dark:bg-black-600 dark:text-neargray-10 rounded-xl soft-shadow h-fit mb-4">
          {status === 'cancelled' && (
            <div className="py-4 px-3 flex items-center text-sm text-orange-900/70 bg-orange-300/30 rounded-md dark:bg-black-200 dark:text-orange-900">
              <FaRegTimesCircle />{' '}
              <span className="ml-2"> Order has been cancelled!</span>
            </div>
          )}
          {status === 'exists' && (
            <div className="py-4 flex px-3 items-center text-sm text-orange-900/70 bg-orange-300/30 rounded-md dark:bg-black-200 dark:text-orange-900">
              <FaRegTimesCircle />{' '}
              <span className="ml-2">
                {' '}
          ...
          {status === 'success' && (
            <div className="py-4 flex px-3 items-center text-sm text-primary  bg-primary-100 rounded-md">
              <FaCheckCircle />{' '}
              <span className="ml-2 text-primary dark:text-neargray-10">
                {' '}
          ...
          <div className="gap-1 items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-1 items-center px-6 py-4  border-b dark:border-black-200">
              <p className="text-gray-500 dark:text-neargray-10 text-xs flex items-center mb-2">
                <Avatar className="text-gray-500 dark:text-neargray-100" />{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-1 items-center px-6 py-4  border-b dark:border-black-200">
            <p className="text-gray-500 dark:text-neargray-10 text-xs flex items-center mb-2">
              <CircleTimer className="text-gray-500 dark:text-neargray-100" />{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-1 items-center px-6 py-4">
            <p className="text-gray-500 dark:text-neargray-10 text-xs flex items-center mb-2">
              <Refresh className="text-gray-500 dark:text-neargray-100" />{' '}
          ...
          <div className="flex items-center justify-end px-6 py-4">
            <button
              ...
              className={`text-[13px] text-white font-semibold px-6 py-2 bg-green-500 dark:bg-green-250 hover:-translate-y-1 hover:scale-100 duration-300 hover:shadow-md hover:shadow-primary rounded ${
                loadingBilling && 'cursor-not-allowed bg-primary-100'
              } `}
            >
            ...
            <a
              href={'/apis'}
              className="ml-4 text-[13px] text-white font-semibold px-6 py-2 bg-green-500 dark:bg-green-250 hover:-translate-y-1 hover:scale-100 duration-300 hover:shadow-md hover:shadow-primary rounded"
            >
              Upgrade / Downgrade
            </a>
          </div>
