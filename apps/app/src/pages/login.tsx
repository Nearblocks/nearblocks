        ...
        <div className="container mx-auto py-20">
          <div className="mx-auto px-5 align-middle max-w-[685px]">
            <form method="post" onSubmit={formik.handleSubmit}>
              <h1 className="text-3xl text-primary dark:text-green-250 py-2 font-semibold text-center">
                Welcome back
              </h1>
              <span className="text-sm text-gray-400 py-2 font-thin text-center">
                {/* Login to your account */}
                <p className="text-gray-500 dark:text-white text-sm my-1 font-thin">
                  Don&apos;t have an account?{' '}
                  <span className="text-primary dark:text-green-250">
                    <Link href="/register">
              ...
              {errorMsg && (
                <p className="text-red-500 bg-red-500/20 px-3 py-3 rounded-md text-xs">
                  {errorMsg}{' '}
                  <Link href="/resend">
                    <span className="text-primary dark:text-green-250 cursor-pointer">
                      [re-sent]
                    </span>
                  </Link>
                </p>
              ...
              <div className="py-2">
                <p className="py-2 text-sm text-gray-500 dark:text-neargray-100">
                  Username or Email
                </p>
                <input
                  autoComplete="off"
              ...
              <div className="py-2">
                <div className="flex justify-between">
                  ...
                  <Link href="/lostpassword">
                    <span className="py-2 text-xs text-gray-500 dark:text-white font-thin hover:text-primary dark:hover:text-green-100">
              ...
              <div className="py-2">
                <p className="text-sm text-gray-500 dark:text-white font-thin">
                  <span>
                    <input
                      type="checkbox"
              ...
              <div className="w-full text-left my-5">
                <button
                  ...
                  type="submit"
                  className={`w-full text-sm focus:outline-none text-white text-center font-semibold py-3 hover:bg-green-400 bg-green-500 rounded ${
                    status != 'solved' &&
                    formik.isSubmitting &&
                              ...
                              <>
                                ...
                                <div className="my-4">
                                  <div className="py-3 text-gray-700">
                                    <div
                                      className="block text-center  border-2 text-sm py-3 rounded w-full focus:outline-none text-primary font-semibold border-primary hover:bg-primary hover:text-white cursor-pointer"
