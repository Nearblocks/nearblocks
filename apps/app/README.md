...
The naerblocks is a Next.js app that serves as a NEAR BOS gateway for the NearBlocks component built on BOS. Its called NEAR BOS gateway based on the docs
