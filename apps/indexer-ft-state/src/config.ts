...
const env = cleanEnv(process.env, {
  ...
  RAW_BATCH_SIZE: num({ default: 500_000 }),
  RAW_BUFFER_MULTIPLIER: num({ default: 1 }),
  RAW_CONCURRENCY: num({ default: 5 }),
...
const config: Config = {
  ...
  network: env.NETWORK,
  rawBatchSize: env.RAW_BATCH_SIZE,
  rawBufferMultiplier: env.RAW_BUFFER_MULTIPLIER,
  rawConcurrency: env.RAW_CONCURRENCY,
  rawLag: 2_000,
  rawThreshold: 5_000,
  rpcUrl: env.RPC_URL,
