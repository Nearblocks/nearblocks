      ...
      <div className="container mx-auto px-3">
        <div className="grid md:grid-cols-12 pt-4 mb-2">
          <div className="md:col-span-5 lg:col-span-4 pt-4">
            <div className="bg-white border rounded-lg soft-shadow p-3 aspect-square">
              {
                <Widget
          ...
          <div className="md:col-span-7 lg:col-span-8 md:px-4 lg:pl-8 pt-4">
            <h1 className="break-all space-x-2 text-xl text-gray-700 leading-8 font-semibold">
              {loading ? <Loader /> : token?.title || token?.token}
            </h1>
            ...
            <Accordion.Root
              type="multiple"
              className="bg-white border rounded-lg soft-shadow mt-4"
            ...
            >
              <Accordion.Item value={1}>
                ...
                <Accordion.Content className="text-sm text-gray-500 border-b">
