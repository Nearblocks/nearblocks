...
CREATE INDEX IF NOT EXISTS eor_produced_receipt_executed_receipt_idx ON execution_outcome_receipts (produced_receipt_id, executed_receipt_id) TABLESPACE execution_outcome_receipts_tbs1;
